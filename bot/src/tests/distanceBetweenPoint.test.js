...
it("should calculate distance between two points", function(){
    let expectedResult = 155689; // метры 155682  - версия онлайн калькулятора
...
it("should calculate distance between two points", function(){
    let expectedResult = 634223; // метры 634193 - версия онлайн калькулятора
...
it("should calculate distance between two points", function(){
    let expectedResult = 2409; // метры 2410 - версия онлайн калькулятора
